package com.supermap.desktop.vectoreditor.gp;
...
import com.supermap.desktop.vectoreditor.VectorEditorProperties;
...
public class DesktopProcessSampleCode extends AbstractDesktopProcess {
    ...
    public DesktopProcessSampleCode() {
        ...
        setTitle(VectorEditorProperties.getString("String_DeleteDuplicatePoints"));
    ...
    public void processResult(HashMap<String, Object> result) {
        if (result.containsKey("resultDataset") && result.get("resultDataset") != null) {
            ...
            Application.getActiveApplication().getOutput().output(MessageFormat.format(VectorEditorProperties.getString("String_DeleteDuplicatePointsSuccess"), datasetVector.getName()));
        } else {
            Application.getActiveApplication().getOutput().output(VectorEditorProperties.getString("String_DeleteDuplicatePointsFailed"));
        }
    }
}
